        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10 items-start md:items-center justify-between">
          <div className="relative w-full md:w-80">
            ...
            <Input
              ...
              className="pl-9 bg-neutral-900 border-neutral-800 text-neutral-100 placeholder:text-neutral-500 focus-visible:ring-1 focus-visible:ring-sky-500 text-sm font-sans"
              value={searchQuery}
              ...
              <article key={article.slug} className="py-8 group">
                <Link href={`/articulos/${article.slug}`} className="block space-y-3">
                  <div className="flex items-center gap-3 font-sans text-xs">
                    <span className="font-bold uppercase tracking-widest text-sky-400">
                      {article.category}
                    </span>
                  ...
                  <h2 className="font-serif text-2xl sm:text-3xl font-normal text-neutral-100 group-hover:text-sky-400 transition-colors leading-snug">
                    {article.title}
                  </h2>
