...
export default function CalculadoraInflacion() {
  ...
  return (
    <div className="p-6 rounded-md shadow-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 transition-all duration-500 max-w-md mx-auto w-full relative overflow-hidden">

      <h2 className='font-serif text-3xl font-medium tracking-tight text-slate-900 dark:text-zinc-100 mb-6 relative z-10'>Calculadora Real vs Inflación</h2>

      <div className='space-y-6 relative z-10'>
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-[11px] font-bold uppercase tracking-widest text-zinc-500">Capital Inicial: <span className="font-mono tabular-nums">{formatPrice(capital)}</span></label>
          </div>
          <input
            type='range'
            min="10000"
        ...
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-[11px] font-bold uppercase tracking-widest text-zinc-500">TNA Estimada: <span className="font-mono tabular-nums">{tna}%</span></label>
          </div>
          <input
            type='range'
            min="0"
        ...
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-[11px] font-bold uppercase tracking-widest text-zinc-500">Inflación Mensual: <span className="font-mono tabular-nums">{inflacion}%</span></label>
          </div>
          <input
            type='range'
            min="0"
      ...
      <div className='mt-8 space-y-3 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-md border border-zinc-200 dark:border-zinc-800 relative z-10'>
        <div className='flex justify-between items-center'>
          <span className='text-[11px] font-bold uppercase tracking-widest text-zinc-500'>Nominal (1 mes):</span>
          <span className='font-mono font-bold tracking-tight tabular-nums text-slate-900 dark:text-zinc-100'>{formatPrice(capitalFinalNominal)}</span>
        </div>
        <div className='flex justify-between items-center pt-3 border-t border-zinc-200 dark:border-zinc-800'>
          <span className='text-[11px] font-bold uppercase tracking-widest text-zinc-500'>Resultado Real:</span>
        ...
        <div className='mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-800'>
          <div className="text-center text-[11px] font-bold uppercase tracking-widest text-zinc-500 mb-2">
            {isPositivo ? 'Poder Adquisitivo Preservado:' : 'Poder Adquisitivo Perdido:'}
          </div>
          <div className="flex justify-center gap-4 text-xs">
            <div className={`px-3 py-2 rounded-md bg-white dark:bg-zinc-900 border ${isPositivo ? 'border-emerald-200 dark:border-emerald-500/50 text-emerald-600 dark:text-emerald-400' : 'border-rose-200 dark:border-rose-500/50 text-rose-600 dark:text-rose-400'}`}>
